package ezen.porfolio.common.dao;
...
import ezen.porfolio.article.dao.JdbcMemoDao;
import ezen.porfolio.article.dao.MemoDao;
import ezen.porfolio.member.dao.JdbcMemberDao;
import ezen.porfolio.member.dao.MemberDao;
...
public class DaoFactory {
	...
	private DaoFactory() {
		...
		dataSource.setUsername("hoho2");
		dataSource.setPassword("hoho2");
